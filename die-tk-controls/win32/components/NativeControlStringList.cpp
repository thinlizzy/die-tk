...
public:
    virtual void update(NativeControlStringList & list, NativeString const & text) = 0;
    virtual void add(NativeControlStringList & list, NativeString const & text) = 0;
    ...
    virtual void insert(NativeControlStringList & list, StringList::iterator pos, NativeString const & text) = 0;
    virtual void replace(NativeControlStringList & list, StringList::iterator pos, NativeString const & text) = 0;
    virtual void erase(NativeControlStringList & list, StringList::iterator pos) = 0;
    virtual NativeString at(NativeControlStringList const & list, size_t pos) const = 0;
};

class FullyLoadedState: public NativeControlStringListState {
public:
    virtual void update(NativeControlStringList & list, NativeString const & text);
    virtual void add(NativeControlStringList & list, NativeString const & text);
    ...
    virtual void insert(NativeControlStringList & list, StringList::iterator pos, NativeString const & text);
    virtual void replace(NativeControlStringList & list, StringList::iterator pos, NativeString const & text);
    virtual void erase(NativeControlStringList & list, StringList::iterator pos);
    virtual NativeString at(NativeControlStringList const & list, size_t pos) const;    
};
...
void FullyLoadedState::update(NativeControlStringList & list, NativeString const & text)
{
    list.state = &partiallyLoaded;
    list.reset(text);
}

void FullyLoadedState::add(NativeControlStringList & list, NativeString const & text)
{
...
void FullyLoadedState::insert(NativeControlStringList & list, StringList::iterator pos, NativeString const & text)
{
    list.actualInsert(pos,text);
}

void FullyLoadedState::replace(NativeControlStringList & list, StringList::iterator pos, NativeString const & text)
{
...
NativeString FullyLoadedState::at(NativeControlStringList const & list, size_t pos) const
{
...
void PartiallyLoadedState::update(NativeControlStringList & list, NativeString const & text)
{
    list.reset(text);
}
...
void PartiallyLoadedState::insert(NativeControlStringList & list, StringList::iterator pos, NativeString const & text)
{
    list.fullLoad();
    FullyLoadedState::insert(list,pos,text);
}

void PartiallyLoadedState::replace(NativeControlStringList & list, StringList::iterator pos, NativeString const & text)
{
    list.fullLoad();
...
NativeString PartiallyLoadedState::at(NativeControlStringList const & list, size_t pos) const
{
    list.fullLoad();
...
void UnloadedState::update(NativeControlStringList & list, NativeString const & text)
{
    // nothing
}

void UnloadedState::add(NativeControlStringList & list, NativeString const & text)
{
    list.partialLoad();
...
void NativeControlStringList::update(NativeString const & text)
{
    state->update(*this,text);
}

void NativeControlStringList::add(NativeString const & text)
{
    state->add(*this,text);
}
...
void NativeControlStringList::insert(iterator pos, NativeString const & text)
{
    state->insert(*this,pos,text);
}

void NativeControlStringList::replace(iterator pos, NativeString const & text)
{
...
NativeString NativeControlStringList::at(size_t pos) const
{
...
void NativeControlStringList::reset(NativeString const & text)
{
    bigString = text;
    positions.clear();
}
...
void NativeControlStringList::addNewLine(NativeString const & text)
{
...
void NativeControlStringList::actualInsert(StringList::iterator pos, NativeString const & text)
{
...
void NativeControlStringList::actualReplace(StringList::iterator pos, NativeString const & text)
{
    auto pos_it = positions.begin() + pos.getPos();
    auto location = *pos_it;
...
NativeString NativeControlStringList::actualAt(size_t pos) const
{
