#include "../../src/controls/ComboBox.h"
...
void ComboBox::addStrings(std::initializer_list<NativeString> strings)
{
...
void ComboBox::addString(NativeString const & str)
{
    IMPL.addString(str);
}

NativeString ComboBox::getString(int index) const
{
